...
void OllamaClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->analysisReady((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->errorOccurred((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->askAI((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->analyzeResult((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (OllamaClient::*)(const QString & )>(_a, &OllamaClient::resultReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (OllamaClient::*)(const QString & )>(_a, &OllamaClient::analysisReady, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (OllamaClient::*)(const QString & )>(_a, &OllamaClient::errorOccurred, 2))
            return;
    }
}
...
// SIGNAL 0
void OllamaClient::resultReady(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void OllamaClient::analysisReady(const QString & _t1)
{
